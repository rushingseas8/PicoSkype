...
public class DraggerPanel extends JPanel {
    ...
    public DraggerPanel(BufferedImage image, boolean lockedDrag) {
        ...
        if(image != null) { 
            ...
            setSize(new Dimension(320, (int)(ratio * 320))); 
            setPreferredSize(new Dimension(320, (int)(ratio * 320))); 
            setMaximumSize(new Dimension(320, (int)(ratio * 320))); 
        }
        else {
    ...
    public static void main() {
        ...
        DraggerPanel panel = new DraggerPanel("http://imgur.com/gallery/PVXfscP", true, 640, 480);
        frame.add(panel);
        frame.setVisible(true);
    }
}